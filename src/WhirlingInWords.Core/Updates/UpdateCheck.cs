...
namespace WhirlingInWords.Core.Updates
{
    /// <summary>
    ...
    public static class UpdateCheck
    {
        ...
        private const string ApiUrl = "https://api.github.com/repos/rashadnaqeeb/WhirlingInWords/releases/latest";
        ...
        public static void Start(string currentVersion, Action<string> logInfo, Action<string> logWarning)
        {
            ...
            var worker = new Thread(() =>
            {
                try
                {
                    ...
                    request.UserAgent = "WhirlingInWords";
